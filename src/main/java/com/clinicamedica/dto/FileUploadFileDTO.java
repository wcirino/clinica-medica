...
public class FileUploadFileDTO implements Serializable{
	...
	public FileUploadFileDTO(String fileName, String fileDownloadUri, String fileType, long size) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileUploadFileDTO other = (FileUploadFileDTO) obj;
