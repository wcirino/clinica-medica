...
public class SwaggerConfig {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.clinicamedica.controller"))
	...
	private ApiInfo metaInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo(
                "Clinica Medica API REST Spring Boot",
                "API REST Clinica Medica, nivel didatico",
                "Version 1.0",
                "Terms of Service",
                new Contact("Willyan Fernando", "Estudos",
                        "wf.crn@gmail.com.br"),
